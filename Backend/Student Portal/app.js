          ...
          doc
            ...
            if (foundItem.middleName != ''){
              doc
                .fontSize(25)
                .fill('black')
                .text('This is to certify that ' + foundItem.firstName +' '+ foundItem.middleName +' '+ foundItem.lastName + ' , USN ' + foundItem.usn + ' is a bonafide student studying in ' + foundItem.semester + ' semester ,B.E Degree Course in ' + foundItem.course + ' in this institution for the academic year 2022-23.', {align: 'center'});
            }else{
              doc
                .fontSize(25)
                .fill('black')
                .text('This is to certify that ' + foundItem.firstName +' '+ foundItem.lastName + ' , USN ' + foundItem.usn + ' is a bonafide student studying in ' + foundItem.semester + ' semester ,B.E Degree Course in ' + foundItem.course + ' in this institution for the academic year 2022-23.', {align: 'center'});
            }
